            ...
            <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-white rounded-3xl border border-dashed border-gray-300">
                        ...
                        <h2 className="text-xl font-bold text-gray-800">Ainda não temos fotos</h2>
                ...
                >
                    ...
                    >
                        ...
                        <div className="mt-6 text-center max-w-3xl">
                            <p className="text-white text-xl font-medium mb-2">{selectedPhoto.caption}</p>
                            <div className="flex items-center justify-center gap-2 text-white/50 text-sm">
                                <Calendar className="w-4 h-4" />
                                {new Date(selectedPhoto.event_date).toLocaleDateString("pt-BR")}
                            </div>
                        </div>
                    </div>
                </div>
